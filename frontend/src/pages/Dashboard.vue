<template>
  <q-page>
    ...
    >
      ...
      <p>
        This device is connected to a jCharge server, but no testing device was found on the local network. Make sure your device is powered on and connected to WiFi.
      </p>
    </div>
